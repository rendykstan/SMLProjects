 ...
 *
 * Revision 1.7  1997/09/29 02:33:13  riccardo
 *   Reimplementation of the Date structure (corrections + cleaning up)
 *
 * Revision 1.6  1997/09/24  14:42:47  riccardo
 *   added support for out-of-OS-range dates
 *
 * Revision 1.5  1997/09/22  16:09:56  riccardo
 *   correction to Date.compare function
 *
 * Revision 1.4  1997/09/11  03:46:41  riccardo
 * corrections to the Date structure
 *
 * Revision 1.3  1997/09/08  16:33:47  jhr
 *   Partial implementation of new Date structure API.
 *
 * Revision 1.2  1997/07/31  17:24:58  jhr
